...
1. Download [**LuckyDBrowserSetup-8.0.0.exe**](https://github.com/Dylanchess0320/LuckyD-Browser/releases/download/v8.0.0/LuckyDBrowserSetup-8.0.0.exe)
...
```powershell
LuckyDBrowserSetup-8.0.0.exe /VERYSILENT /NORESTART
```
...
Install the new `LuckyDBrowserSetup-8.0.0.exe` right over your existing install — profile, settings, and workspaces carry over. The browser also checks for updates itself and can install them in-app with one click.
