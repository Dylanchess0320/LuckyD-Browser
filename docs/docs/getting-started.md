...
1. Download [**LuckyDBrowserSetup-4.0.0.exe**](https://github.com/Dylanchess0320/LuckyD-Browser/releases/tag/v4.0.0)
...
```powershell
LuckyDBrowserSetup-4.0.0.exe /VERYSILENT /NORESTART
```
...
Install the new `LuckyDBrowserSetup-4.0.0.exe` right over your existing install — profile, settings, and workspaces carry over. The browser also checks for updates itself and can install them in-app with one click.
