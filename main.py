...
async def handle_command(agent: CodingAgent, cmd: str) -> bool:
    ...
    if cmd in ("q", "quit", "exit"):
        ...
        agent_version = os.environ.get("LUCKYD_AGENT_VERSION", "v9.2.0")
    ...
    while i < len(args):
        if args[i] == "--model" and i + 1 < len(args):
            ...
            if slot == "2":
                ...
                os.environ["LUCKYD_AGENT_VERSION"] = "v9.2.0"
            i += 2
...
Usage:
  lucky-code                       Interactive REPL (Agent 1 · v9.2.0)
...
Options:
  --agent 1|2        Select agent slot (1 = v9.2 Nuitka, 2 = v2.2)
