...
class Bridge:
    ...
    # â”€â”€ terminal server â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    def start_terminals(self) -> bool:
        try:
            ...
            return False
        self.terminals = TerminalServer(
            host="127.0.0.1", port=self.ws_port, token=self.token
        )
    ...
    # â”€â”€ model catalog / settings â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_GET(self) -> None:
            ...
            if path == "/api/ping":
                ...
                self._send_json(
                    {"ok": True, "ws_port": bridge.ws_port, "shells": shells}
                )
                return
            if path == "/api/catalog":
            ...
            if path == "/terminal":
                ...
                try:
                    ...
                    return
                self._send(
                    200, html.encode("utf-8"), "text/html; charset=utf-8", cookie=True
                )
                return
