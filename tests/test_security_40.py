...
class TestVersionUnification:
    ...
    def test_versions_unified_at_current(self):
        ...
        assert browser.__version__ == "10.2.1"

        with open(_REPO_ROOT / "pyproject.toml", "rb") as f:
            assert tomllib.load(f)["project"]["version"] == "10.2.1"
        ...
        assert "10.2.1.0" in version_info
        ...
        assert "filevers=(10, 2, 1, 0)" in version_info
        assert "prodvers=(10, 2, 1, 0)" in version_info
