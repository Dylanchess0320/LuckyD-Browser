...
- DRS_PROVIDER: auto | gemini | luckyd | mock — picks the LLM backend.
...
class Settings:
    ...
    # Provider selection: auto | gemini | luckyd | mock
    ...
    def effective_search_backend(self, provider_name: str = "") -> str:
        ...
        if provider_name == "gemini" and self.api_key:
            return "gemini"
        # LuckyD multi-provider runs use keyless DDG + fetch by default.
        return "ddg"
