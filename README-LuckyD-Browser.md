...
<p align="center">
  <img src="docs/screenshots/dashboard-v2.png" alt="LuckyD Browser — the Neon Night dashboard: AI status, tabs, and your tools in one window" width="920"><br>
...
**[⬇ Download Latest Release](https://github.com/Dylanchess0320/LuckyD-Browser/releases/latest)** (`LuckyDBrowserSetup-10.4.0.exe`)
...
- Silent install for scripting: `LuckyDBrowserSetup-10.4.0.exe /VERYSILENT /NORESTART`
