...
**[⬇ Download v3.6.0](https://github.com/Dylanchess0320/LuckyD-Browser/releases/tag/v3.6.0)** (`LuckyDBrowserSetup-3.6.0.exe`)
...
- Silent install for scripting: `LuckyDBrowserSetup-3.6.0.exe /VERYSILENT /NORESTART`
