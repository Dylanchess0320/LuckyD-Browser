...
;   browser\installer\output\LuckyDBrowserSetup-2.2.0.exe
;
...
VersionInfoVersion=2.5.10.0
VersionInfoCompany={#AppPublisher}
VersionInfoDescription={#AppName} Setup
VersionInfoProductName={#AppName}
VersionInfoProductVersion=2.5.10.0
...
OutputDir=output
OutputBaseFilename=LuckyDBrowserSetup-2.5.10
